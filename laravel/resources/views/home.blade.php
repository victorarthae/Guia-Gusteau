...
<div class="container">
    <div class="header clearfix">
        <nav>
            <ul class="nav nav-pills pull-right">
                ...
                <li role="presentation"><a href="#">Login/Registrar</a></li>
            </ul>
        </nav>
    ...
    <div class="jumbotron">
        ...
        <p></p>
        <input type="text" placeholder="User virgula para separar os ingredientes" class="form-control">
        <p></p>
        <p><a class="btn btn-lg btn-success" href="#" role="button">Pesquisar</a></p>
    </div>
    <div class="row">
